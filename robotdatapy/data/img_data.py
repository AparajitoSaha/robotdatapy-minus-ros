...
class ImgData(RobotData):
    ...
    def __init__(
        ...
        Args:
            ...
            data_type (str): type of data file: 'kitti', 'raw'
    ...
    def from_kitti(cls, path, kitti_type, kitti_sequence='00', time_range=None, time_tol=.1, causal=False, 
        ...
        """
        Creates ImgData object from KITTI file
    ...
    def extract_params(self, topic=None):
        ...
        if self.data_type == 'kitti':
            ...
            assert False, "data_type not supported, please choose from: kitti"
    ...
    def _load_img(self, idx: int):
        ...
        Returns:
            cv image
        """
        if self.data_type == 'kitti' and self.kitti_type == 'rgb':
            ...
            raise ValueError("data_type not supported, please choose from: raw, kitti")
